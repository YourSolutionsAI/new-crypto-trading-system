  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        <div>
          <span className="text-gray-500 block text-xs mb-1">Base Asset</span>
          <span className="font-medium text-gray-900">{symbol.baseAsset}</span>
          <span className="text-xs text-gray-400 ml-1">(Prec: {symbol.baseAssetPrecision})</span>
        </div>
        <div>
          <span className="text-gray-500 block text-xs mb-1">Quote Asset</span>
          <span className="font-medium text-gray-900">{symbol.quoteAsset}</span>
          <span className="text-xs text-gray-400 ml-1">(Prec: {symbol.quoteAssetPrecision})</span>
        </div>
        <div>
          <span className="text-gray-500 block text-xs mb-1">Quote Precision</span>
          <span className="font-medium text-gray-900">{symbol.quotePrecision}</span>
        </div>
        <div>
          <span className="text-gray-500 block text-xs mb-1">Margin Trading</span>
      ...
      {priceFilter && (
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
          ...
          <div className="grid grid-cols-3 gap-3 text-xs">
            <div>
              <span className="text-blue-700 block mb-1">Min Price</span>
              <span className="font-mono text-blue-900 font-medium">
                {formatValue(priceFilter.minPrice)}
              </span>
            </div>
            <div>
              <span className="text-blue-700 block mb-1">Max Price</span>
              <span className="font-mono text-blue-900 font-medium">
                {formatValue(priceFilter.maxPrice)}
              </span>
            </div>
            <div>
              <span className="text-blue-700 block mb-1">Tick Size</span>
              <span className="font-mono text-blue-900 font-medium">
      ...
      {lotSizeFilter && (
        <div className="bg-green-50 rounded-lg p-3 border border-green-100">
          ...
          <div className="grid grid-cols-3 gap-3 text-xs">
            <div>
              <span className="text-green-700 block mb-1">Min Qty</span>
              <span className="font-mono text-green-900 font-medium">
                {formatValue(lotSizeFilter.minQty)}
              </span>
            </div>
            <div>
              <span className="text-green-700 block mb-1">Max Qty</span>
              <span className="font-mono text-green-900 font-medium">
                {formatValue(lotSizeFilter.maxQty)}
              </span>
            </div>
            <div>
              <span className="text-green-700 block mb-1">Step Size</span>
              <span className="font-mono text-green-900 font-medium">
      ...
      {notionalFilter && (
        <div className="bg-amber-50 rounded-lg p-3 border border-amber-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
            <div>
              <span className="text-amber-700 block mb-1">Min Notional</span>
            ...
            {notionalFilter.maxNotional && (
              <div>
                <span className="text-amber-700 block mb-1">Max Notional</span>
                <span className="font-mono text-amber-900 font-medium">
            ...
            <div>
              <span className="text-amber-700 block mb-1">Apply to Market</span>
              <span className="font-mono text-amber-900 font-medium">
